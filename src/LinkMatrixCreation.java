...
public class LinkMatrixCreation {
	...
	private static int[] columnsCount(int[][] tab) {
		//méthode permettant de calculer le nombre d'occurences de 1 dans les diff�rentes colonnes
		int N=tab[0].length;
	...
	private static void updateCount(RootObject root,int N, int[][] tab){
		//méthode permettant de mettre � jour le champ S des diff�rentes colonnes
